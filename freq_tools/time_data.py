...
class CounterData():
    ...
    sample_rate : float
        sampling rate in Hz
    divide_by : int
        If a prescaler was used, provide the divide-by factor. Used for calculation of oscillator
        noise, c.p. `to_oscillator_noise` method.
    """
    ...
    def to_oscillator_noise(self):
        ...
        noise : OscillatorNoise
            Creates a SpectralDenisty object and initializes it with the calculated ASD using the 
            Welch method
        """
